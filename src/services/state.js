...
const datasets = {
  ...
  templates: normalizeTenantedCollection(loadData('templates.json', [])),
  integrations: normalizeTenantedCollection(loadData('integrations.json', [])),
  marketplaceEvents: normalizeTenantedCollection(loadData('marketplaceEvents.json', []))
};
...
const persist = {
  ...
  templates: data => saveData('templates.json', data),
  integrations: data => saveData('integrations.json', data),
  marketplaceEvents: data => saveData('marketplaceEvents.json', data)
};
